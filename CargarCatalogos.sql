...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN TRY SET IDENTITY_INSERT EstadoFactura ON; END TRY BEGIN CATCH END CATCH
            ...
            BEGIN TRY SET IDENTITY_INSERT EstadoFactura OFF; END TRY BEGIN CATCH END CATCH
        END

        -- Estados de Orden de Corta
        IF NOT EXISTS (SELECT 1 FROM EstadoOrdenCorta WHERE Id = 1)
        BEGIN
            BEGIN TRY SET IDENTITY_INSERT EstadoOrdenCorta ON; END TRY BEGIN CATCH END CATCH
            ...
            BEGIN TRY SET IDENTITY_INSERT EstadoOrdenCorta OFF; END TRY BEGIN CATCH END CATCH
        END
        ...
        COMMIT TRANSACTION;
        PRINT 'Carga de catálogos y estados completada exitosamente.';
    END TRY
    BEGIN CATCH
